...
```sh
bun run build
bun dist/cli/index.js init examples/synthetic-fixtures/media/talking-head-demo.mp4 \
...
bun dist/cli/index.js prepare examples/synthetic-fixtures/projects/talking-head-demo
bun dist/cli/index.js plan examples/synthetic-fixtures/projects/talking-head-demo
bun dist/cli/index.js render examples/synthetic-fixtures/projects/talking-head-demo
```
