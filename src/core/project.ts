...
export const CLIP_CANDIDATE_EVIDENCE_FILE = "review/clip-candidate-evidence.md";
...
export function clipCandidateEvidencePath(projectDir: string): string {
  return join(resolveProjectDir(projectDir), CLIP_CANDIDATE_EVIDENCE_FILE);
}
